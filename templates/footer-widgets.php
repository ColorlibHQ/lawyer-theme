...
$footer_logo_img 	= wp_get_attachment_image_src( $footer_logo_img_id , 'lawyer_site_logo_172x57' )[0];
$footer_text 	    = lawyer_opt( 'lawyer_footer_text' );
$site_url 	    	= home_url('/');
		?>
		<div class="col-xl-4 col-md-6 col-lg-3">
			<div class="footer_widget">
				<?php
					...
					// Social profiles
					$social_opt = lawyer_opt('lawyer_social_profile_toggle');
					if ( $social_opt == true ) {
						$social_items = lawyer_opt('lawyer_social_profiles');
