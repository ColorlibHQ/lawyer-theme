...
// image default alt
if ( ! function_exists( 'lawyer_img_default_alt' ) ) {
	function lawyer_img_default_alt( $url = '' ) {
...
// Image Tag
if ( ! function_exists( 'lawyer_img_tag' ) ) {
	function lawyer_img_tag( array $args ) {
		...
		if ( ! empty( $args['alt'] ) ) {
			...
			$alt = lawyer_img_default_alt( $url );
		}
...
// Anchor Tag
if ( ! function_exists( 'lawyer_anchor_tag' ) ) {
	function lawyer_anchor_tag( array $args ) {
...
// Heading Tag
if ( ! function_exists( 'lawyer_heading_tag' ) ) {
	function lawyer_heading_tag( array $args ) {
...
// Paragraph Tag
if ( ! function_exists( 'lawyer_paragraph_tag' ) ) {
	function lawyer_paragraph_tag( array $args ) {
...
// Other Tag
if ( ! function_exists( 'lawyer_other_tag' ) ) {
	function lawyer_other_tag( array $args ) {
...
// Button Element 
if ( ! function_exists( 'lawyer_button_element ' ) ) {
	function lawyer_button_element( array $args ) {
