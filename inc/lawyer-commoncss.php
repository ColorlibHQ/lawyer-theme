...
// enqueue css
function lawyer_common_custom_css(){
    
    wp_enqueue_style( 'lawyer-common', get_template_directory_uri().'/assets/css/common.css' );

		$whiteColor     		  	= '#ffffff';
		$themeColor     		  	= lawyer_opt( 'lawyer_theme_color' ) != '#131313' ? lawyer_opt( 'lawyer_theme_color' ) : '';
		$themeSecColor     		  	= '';
		$bookBtnColor       		= lawyer_opt( 'lawyer_book_btn_color' ) != '#131313' ? lawyer_opt('lawyer_book_btn_color') : '';
		$bookBtnHoverBgColor     	= lawyer_opt( 'lawyer_book_btn_hvr_bg_color' ) != '#131313' ? lawyer_opt('lawyer_book_btn_hvr_bg_color') : $themeColor;
		$hoverColor     	  	  = lawyer_opt( 'lawyer_quote_btn_hvr_text_color');

		$headerTop_bg     		  = '';
		$navbarBgColor     		  = lawyer_opt( 'lawyer_navbar_bg_color' ) != '#082b49' ? lawyer_opt( 'lawyer_navbar_bg_color') : '';
		$headerTop_col     		  = lawyer_opt( 'lawyer_top_header_color' );

		$headerTopBg      		  = lawyer_opt( 'lawyer_top_header_bg_color');
		$headerBg          		  = lawyer_opt( 'lawyer_header_bg_color') != '#ffffff' ? lawyer_opt( 'lawyer_header_bg_color') : '';
		$menuColor          	  = lawyer_opt( 'lawyer_header_menu_color' ) != '#131313' ? lawyer_opt('lawyer_header_menu_color') : '';
		$menuHoverColor           = lawyer_opt( 'lawyer_header_menu_hover_color' ) != '#808080' ? lawyer_opt('lawyer_header_menu_hover_color') : $themeColor;
		$menuFixedHoverColor      = lawyer_opt( 'lawyer_header_menu_fixed_hover_color' );
		$dropMenuBgColor          = lawyer_opt( 'lawyer_header_drop_menu_bg_color' ) != '#ffffff' ? lawyer_opt('lawyer_header_drop_menu_bg_color') : $themeColor;
		$dropMenuColor            = lawyer_opt( 'lawyer_dropdown_menu_color' ) != '#131313' ? lawyer_opt('lawyer_dropdown_menu_color') : '';
		$dropMenuHovColor         = lawyer_opt( 'lawyer_dropdown_menu_hover_color' ) != '#808080' ? lawyer_opt('lawyer_dropdown_menu_hover_color') : $themeColor;

		$footerwbgColor     	  = lawyer_opt( 'lawyer_footer_widget_bg_color' );
		$footerwHeadColor   	  = lawyer_opt('lawyer_footer_widget_heading_color');
		$footerwTextColor   	  = lawyer_opt('lawyer_footer_widget_text_color');
		$footerwanchorcolor 	  = lawyer_opt('lawyer_footer_widget_anchor_color') != '#ffffff' ? lawyer_opt('lawyer_footer_widget_anchor_color') : '';
		$footerwanchorhovcolor    = lawyer_opt('lawyer_footer_widget_anchor_hover_color') != '#ffffff' ? lawyer_opt('lawyer_footer_widget_anchor_hover_color') : '';
		
		$fofbg					  = lawyer_opt('lawyer_fof_bg_color');
		$foftonecolor			  = lawyer_opt('lawyer_fof_textone_color');
		...
		$customcss ="			
			...
			.footer-area .single-footer-widget .btn, .footer .footer_top .footer_widget .lawyer_mailchimp_newsletter_widget button, .footer .footer_top .footer_widget .lawyer_mailchimp_newsletter_widget button
			{
    ...
    wp_add_inline_style( 'lawyer-common', $customcss );
    
}
add_action( 'wp_enqueue_scripts', 'lawyer_common_custom_css', 50 );